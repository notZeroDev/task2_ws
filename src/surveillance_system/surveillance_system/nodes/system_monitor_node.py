...
class SystemMonitorNode(Node):
    def __init__(self):
        ...
        self.create_subscription(
            DetectedObjects, "/detected_objects", self.detections_callback, 10
        )
        ...
        self.create_subscription(
            SecurityAlert, "/security_alert", self.alert_callback, 10
        )
    ...
    def detections_callback(self, msg):
        ...
        self._detections = [
            f"{l}({c:.0%})" for l, c in zip(msg.labels, msg.confidences)
        ]
    ...
    def scene_callback(self, msg):
        ...
        self._dangerous = [
            msg.labels[i] for i in range(len(msg.labels)) if msg.is_dangerous[i]
        ]
